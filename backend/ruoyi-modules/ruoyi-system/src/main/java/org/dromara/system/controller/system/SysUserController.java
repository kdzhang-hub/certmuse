...
import org.dromara.system.service.AuthEntryResolver;
...
public class SysUserController extends BaseController {
    ...
    private final AuthEntryResolver authEntryResolver;
    ...
    public R<UserInfoVo> getInfo() {
        ...
        String entryType;
        try {
            entryType = authEntryResolver.resolve(loginUser.getUserId()).name();
            if (!entryType.equals(loginUser.getEntryType())) {
                StpUtil.logout();
                return R.fail("登录状态已失效");
            }
        } catch (org.dromara.common.core.exception.ServiceException e) {
            log.warn("Login entry validation failed, userId={}", loginUser.getUserId());
            StpUtil.logout();
            return R.fail("登录状态已失效");
        }
        ...
        userInfoVo.setEntryType(entryType);
