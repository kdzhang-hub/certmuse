...
public class SysUserServiceImpl implements ISysUserService, UserService {
    ...
    /** Validates the resulting account entry after a user-role relationship change. */
    private void validateUserEntry(Long userId) {
        List<SysRoleVo> roles = roleMapper.selectRolesByUserId(userId).stream()
            ...
            .toList();
        entryPolicy.validateOptional(roles, menuMapper.selectMenuPermsByUserId(userId));
    }
