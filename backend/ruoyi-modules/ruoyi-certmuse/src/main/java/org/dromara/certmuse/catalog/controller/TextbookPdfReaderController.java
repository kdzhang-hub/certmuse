...
/** Same-origin browser stream for an already authorized textbook-PDF reader ticket. */
@SaIgnore
@RestController
@RequiredArgsConstructor
@RequestMapping("/api/reader/textbook-pdfs")
public class TextbookPdfReaderController {
    ...
    private void write(String value, String rangeHeader, HttpServletResponse response, boolean head) throws IOException {
        TextbookPdfReaderTicket ticket = service.resolveReaderTicket(value);
