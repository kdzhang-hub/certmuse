...
/** Full frozen replay of one completed practice session. */
public record HistoryPracticeDetailVo(
    String sessionId, String practiceType, String title, LookupVo subject,
    OffsetDateTime startedAt, OffsetDateTime completedAt, SummaryVo summary,
    List<QuestionVo> questions
) {
    public record LookupVo(String id, String name) { }
    public record SummaryVo(int questionCount, int answeredCount, int correctCount,
