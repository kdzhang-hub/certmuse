...
public class SaTokenExceptionHandler {
    ...
    public R<Void> handleNotAccessException(RuntimeException e, HttpServletRequest request) {
        ...
        log.warn("请求地址'{}',{}，异常类型={}", requestURI, reason, safeLogReason(e));
    ...
    public R<Void> handleNotLoginException(NotLoginException e, HttpServletRequest request) {
        String requestURI = request.getRequestURI();
        log.warn("请求地址'{}',认证失败，异常类型={}，无法访问系统资源", requestURI, safeLogReason(e));
    ...
    static String safeLogReason(RuntimeException exception) {
