...
public class PasswordAuthStrategy implements IAuthStrategy {
    ...
    public LoginVo login(String body, SysClientVo client) {
        ...
        try {
            ...
            log.warn("Login entry validation failed, userId={}", user.getUserId());
        ...
        try {
            ...
            loginVo.setEntryType(loginUser.getEntryType());
            loginVo.setFirstLogin(loginService.markFirstLogin(user.getUserId()));
        } catch (Exception e) {
            StpUtil.logout();
            throw e;
        }
