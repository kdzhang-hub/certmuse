...
-- Certification-scoped documents and import batches were introduced after the
-- previous cascade finalizer. Reconcile the complete descendant graph again so
-- deleting a qualification removes every dependent business row atomically.
DO $$
DECLARE
