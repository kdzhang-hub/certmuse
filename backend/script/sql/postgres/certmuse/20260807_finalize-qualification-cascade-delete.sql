...
-- Later migrations can add new descendants after the original cascade conversion.
-- Reconcile the complete final graph while leaving already-cascading constraints intact.
DO $$
DECLARE
