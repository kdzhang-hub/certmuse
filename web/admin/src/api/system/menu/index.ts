...
// 查询菜单详细
export const getMenu = (menuId: string): AxiosPromise<MenuVO> => {
  return request({
...
// 根据角色ID查询菜单下拉树结构
export const roleMenuTreeselect = (roleId: string): AxiosPromise<RoleMenuTree> => {
  return request({
...
// 级联删除菜单
export const cascadeDelMenu = (menuIds: string[]) => {
  return request({
