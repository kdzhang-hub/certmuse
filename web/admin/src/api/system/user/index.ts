 ...
 * @param userIds
 */
export const optionSelect = (userIds: string[]): AxiosPromise<UserVO[]> => {
  return request({
 ...
 * @param userId
 */
export const getUser = (userId?: string): AxiosPromise<UserInfoVO> => {
  return request({
 ...
 * @param userId 用户ID
 */
export const delUser = (userId: string[] | string) => {
  return request({
 ...
 * @param userId 用户ID
 */
export const getAuthRole = (userId: string): AxiosPromise<{ user: UserVO; roles: RoleVO[] }> => {
  return request({
 ...
 * @param deptId
 */
export const listUserByDeptId = (deptId: string): AxiosPromise<UserVO[]> => {
  return request({
