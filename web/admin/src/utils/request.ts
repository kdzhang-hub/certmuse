...
function createHandledError<T = unknown>(message: string, responseCode?: number, responseData?: T) {
...
service.interceptors.response.use(
  (res: any) => {
    ...
    if (code === 401) {
      ...
      return Promise.reject(createHandledError(msg, code, res.data.data));
